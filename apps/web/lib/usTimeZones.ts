...
/**
 * NOTE:
 * This is a simplified mapping by state and is not 100% accurate for all states
 * (some states span multiple time zones). For MVP, this is usually "good enough".
 */
...
/**
 * Format an ISO timestamp in a specific IANA timezone (or local if tz is null).
 * Returns "—" if iso is missing/invalid.
 */
